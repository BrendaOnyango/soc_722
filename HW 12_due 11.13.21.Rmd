...
tell me a bit about what you want to talk about in the presentation. Tell me what dataset you are interested in, what variables grab your attention, and - given the nature of those variables - what kind of model would be useful to examine a relationship between them.

I'll be using the GSS to analyze 